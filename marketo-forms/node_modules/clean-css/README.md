...
##***REMOVED***What are the requirements?

```
Node.js 0.10+ (tested on CentOS, Ubuntu, OS X 10.6+, and Windows 7+) or io.js 3.0+
```

##***REMOVED***How to install clean-css?

```
npm install clean-css
```

##***REMOVED***How to use clean-css CLI?
...
##***REMOVED***How to use clean-css API?
...
###***REMOVED***How to make sure remote `@import`s are processed correctly?
...
##***REMOVED***How to use clean-css with build tools?
...
##***REMOVED***What are the clean-css' dev commands?
...
##***REMOVED***How to rebase relative image URLs?
...
##***REMOVED***How to generate source maps?
...
##***REMOVED***How to minify multiple files with API?

###***REMOVED***Passing an array

```js
new CleanCSS().minify(['path/to/file/one', 'path/to/file/two']);
```

###***REMOVED***Passing a hash
...
##***REMOVED***How to set a compatibility mode?
...
##***REMOVED***What advanced optimizations are applied?
...
#***REMOVED***Acknowledgments (sorted alphabetically)
