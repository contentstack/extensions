...
- `inline` – add source map into result CSS (via `/****REMOVED***sourceMappingURL=application/json;base64,... */`)
...
###***REMOVED***minifyBlock(source[, options])
...
###***REMOVED***translateWithSourceMap(ast)
