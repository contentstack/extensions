...
##***REMOVED***`sourceMapResolve.resolveSourceMap(code, codeUrl, read, callback)` ###
...
##***REMOVED***`sourceMapResolve.resolveSources(map, mapUrl, read, [options], callback)` ###
...
##***REMOVED***`sourceMapResolve.resolve(code, codeUrl, read, [options], callback)` ###
...
##***REMOVED***`sourceMapResolve.parseMapToJSON(string, [data])` ###
