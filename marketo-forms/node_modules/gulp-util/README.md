***REMOVED***gulp-util [![NPM version][npm-image]][npm-url] [![Build Status][travis-image]][travis-url] [![Coveralls Status][coveralls-image]][coveralls-url] [![Dependency Status][depstat-image]][depstat-url]
...
##***REMOVED***replaceExtension(path, newExtension)

Replaces a file extension in a path. Returns the new path.

##***REMOVED***isStream(obj)

Returns true or false if an object is a stream.

##***REMOVED***isBuffer(obj)

Returns true or false if an object is a Buffer.

##***REMOVED***template(string[, data])
...
#***REMOVED***new PluginError(pluginName, message[, options])
