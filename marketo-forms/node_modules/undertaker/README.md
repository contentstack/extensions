...
##***REMOVED***`new Undertaker([registryInstance])`
...
##***REMOVED***`registry([registryInstance])`
...
##***REMOVED***`lastRun(task, [timeResolution])`
...
##***REMOVED***Sharing Functionalities
