***REMOVED***babel-plugin-transform-es2015-modules-umd
...
##***REMOVED***Via `.babelrc` (Recommended)
...
###***REMOVED***More flexible semantics with `exactGlobals: true`
