...
var inputMap = input.match(/\/\****REMOVED***sourceMappingURL=(\S+)\s*\*\/\s*$/);
...
console.log(
  output.css +
  '/****REMOVED***sourceMappingURL=data:application/json;base64,' +
