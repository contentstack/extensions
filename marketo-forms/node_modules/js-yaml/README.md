...
##***REMOVED***YAML module for node.js
...
##***REMOVED***Bundled YAML library for browsers
...
##***REMOVED***safeLoad (string [ , options ])
...
##***REMOVED***safeLoadAll (string, iterator [ , options ])
...
##***REMOVED***loadAll (string, iterator [ , options ])

Same as `safeLoadAll()` but uses `DEFAULT_FULL_SCHEMA` by default.


##***REMOVED***safeDump (object [ , options ])
...
```
!!null ''                   ***REMOVED***null
!!bool 'yes'                ***REMOVED***bool
!!int '3...'                ***REMOVED***number
!!float '3.14...'           ***REMOVED***number
!!binary '...base64...'     ***REMOVED***buffer
!!timestamp 'YYYY-...'      ***REMOVED***date
!!omap [ ... ]              ***REMOVED***array of key-value pairs
!!pairs [ ... ]             ***REMOVED***array or array pairs
!!set { ... }               ***REMOVED***array of objects with given keys and null values
!!str '...'                 ***REMOVED***string
!!seq [ ... ]               ***REMOVED***array
!!map { ... }               ***REMOVED***object
```
...
```
!!js/regexp /pattern/gim            ***REMOVED***RegExp
!!js/undefined ''                   ***REMOVED***Undefined
!!js/function 'function () {...}'   ***REMOVED***Function
```
