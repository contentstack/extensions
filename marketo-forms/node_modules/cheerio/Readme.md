...
##***REMOVED***Markup example we'll be using:
...
###***REMOVED***.toggleClass( className, [switch] )
...
###***REMOVED***.find(selector)
###***REMOVED***.find(selection)
###***REMOVED***.find(node)
...
###***REMOVED***.parentsUntil([selector][,filter])
...
###***REMOVED***.nextUntil([selector], [filter])
...
###***REMOVED***.prevUntil([selector], [filter])
...
###***REMOVED***.each( function(index, element) )
...
###***REMOVED***.map( function(index, element) )
...
###***REMOVED***.filter( selector ) <br /> .filter( selection ) <br /> .filter( element ) <br /> .filter( function(index) )
...
###***REMOVED***.not( selector ) <br /> .not( selection ) <br /> .not( element ) <br /> .not( function(index, elem) )
...
###***REMOVED***.has( selector ) <br /> .has( element )
...
###***REMOVED***.index()
###***REMOVED***.index( selector )
###***REMOVED***.index( nodeOrSelection )
...
###***REMOVED***.add( selector [, context] )
###***REMOVED***.add( element )
###***REMOVED***.add( elements )
###***REMOVED***.add( html )
...
###***REMOVED***.append( content, [content, ...] )
...
###***REMOVED***.prepend( content, [content, ...] )
...
###***REMOVED***.before( content, [content, ...] )
...
###***REMOVED***.css( [propertName] ) <br /> .css( [ propertyNames] ) <br /> .css( [propertyName], [value] ) <br /> .css( [propertName], [function] ) <br /> .css( [properties] )
...
#***REMOVED***When I would use JSDOM
...
#***REMOVED***Cheerio in the real world
