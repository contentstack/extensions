...
##***REMOVED***`normalize(coercer, value[, ...appliedArguments])`
...
###***REMOVED***`normalize.object(value[, ...appliedArguments])`

Convenience method for `normalize('object', ...)`.

###***REMOVED***`normalize.number(value[, ...appliedArguments])`

Convenience method for `normalize('number', ...)`.

###***REMOVED***`normalize.string(value[, ...appliedArguments])`

Convenience method for `normalize('string', ...)`.

###***REMOVED***`normalize.symbol(value[, ...appliedArguments])`

Convenience method for `normalize('symbol', ...)`.

###***REMOVED***`normalize.boolean(value[, ...appliedArguments])`

Convenience method for `normalize('boolean', ...)`.

###***REMOVED***`normalize.function(value[, ...appliedArguments])`

Convenience method for `normalize('function', ...)`.

###***REMOVED***`normalize.date(value[, ...appliedArguments])`
