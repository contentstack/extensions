...
##***REMOVED***`parallel(fns..., [extensions])`
...
##***REMOVED***`settleSeries(fns..., [extensions])`
...
##***REMOVED***`settleParallel(fns..., [extensions])`
...
####***REMOVED***`extensions.create(fn, index)`
