***REMOVED***[each-props][repo-url] [![NPM][npm-img]][npm-url] [![MIT License][mit-img]][mit-url] [![Build Status][travis-img]][travis-url] [![Build Status][appveyor-img]][appveyor-url] [![Coverage Status][coverage-img]][coverage-url]
...
##***REMOVED***<u>eachProps(obj, fn [, opts]) : void</u>
...
* **API of *fn* function**
    ...
    ###***REMOVED***<u>fn(value, keyChain, nodeInfo) : boolean</u>
