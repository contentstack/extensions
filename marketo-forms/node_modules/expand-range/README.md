...
```sh
***REMOVED***benchmark/fixtures/alpha-lower.js (29 bytes)
...
***REMOVED***benchmark/fixtures/alpha-upper.js (29 bytes)
...
***REMOVED***benchmark/fixtures/padded.js (33 bytes)
...
***REMOVED***benchmark/fixtures/range.js (29 bytes)
