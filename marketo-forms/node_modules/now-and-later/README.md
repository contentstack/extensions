...
##***REMOVED***`map(values, iterator[, extensions][, callback])`
...
###***REMOVED***`iterator(value, key, done)`
...
####***REMOVED***`extensions.create(value, key)`
...
####***REMOVED***`extensions.error(error, storage)`
...
###***REMOVED***`callback(error, results)`
...
##***REMOVED***`mapSeries(values, iterator[, extensions][, callback])`
