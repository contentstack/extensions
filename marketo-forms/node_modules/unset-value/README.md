...
##***REMOVED***Updates the object when a property is deleted
...
##***REMOVED***Returns true when a property is deleted

```js
unset({a: 'b'}, 'a') // true
```

##***REMOVED***Returns `true` when a property does not exist
...
##***REMOVED***throws on invalid args
