***REMOVED***Chokidar 2.0.2 (Feb 14, 2018)
* Allow semver range updates for upath dependency

***REMOVED***Chokidar 2.0.1 (Feb 8, 2018)
...
***REMOVED***Chokidar 2.0.0 (Dec 29, 2017)
...
***REMOVED***Chokidar 1.7.0 (May 8, 2017)
...
***REMOVED***Chokidar 1.5.1 (May 20, 2016)
...
***REMOVED***Chokidar 1.3.0 (Nov 18, 2015)
...
***REMOVED***Chokidar 0.11.1 (Nov 19, 2014)
* Fix a bug where an error is thrown when `fs.watch` instantiation fails

***REMOVED***Chokidar 0.11.0 (Nov 16, 2014)
...
***REMOVED***Chokidar 0.10.5 (Nov 6, 2014)
...
***REMOVED***Chokidar 0.9.0 (Sep 25, 2014)
...
***REMOVED***Chokidar 0.7.1 (Nov 18, 2013)
* `Watcher#close` now also removes all event listeners.

***REMOVED***Chokidar 0.7.0 (Oct 22, 2013)
...
***REMOVED***Chokidar 0.6.3 (Aug 12, 2013)
...
***REMOVED***Chokidar 0.6.2 (Mar 19, 2013)
* Fixed watching initially empty directories with `ignoreInitial` option.

***REMOVED***Chokidar 0.6.1 (Mar 19, 2013)
* Added node.js 0.10 support.

***REMOVED***Chokidar 0.6.0 (Mar 10, 2013)
...
***REMOVED***Chokidar 0.4.0 (Jul 26, 2012)
