***REMOVED***rechoir [![Build Status](https://secure.travis-ci.org/tkellen/js-rechoir.png)](http://travis-ci.org/tkellen/js-rechoir)
...
##***REMOVED***prepare(config, filepath, requireFrom)
