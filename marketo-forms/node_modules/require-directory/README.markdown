...
##***REMOVED***Installation (via [npm](https://npmjs.org/package/require-directory))
...
##***REMOVED***Specifying Another Directory
...
##***REMOVED***Visiting Objects As They're Loaded
