...
####***REMOVED***`options.resolveSymlinks`
...
####***REMOVED***`options.relativeSymlinks`
...
##***REMOVED***`symlink(folder[, options])`
...
###***REMOVED***Symbolic Links on Windows
