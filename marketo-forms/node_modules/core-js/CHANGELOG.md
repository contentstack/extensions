...
####***REMOVED***1.2.7 [LEGACY] - 2016.07.18
...
####***REMOVED***0.9.6 - 2015.05.01
* Added [`String#lpad`, `String#rpad`](https://github.com/zloirock/core-js/#ecmascript-7-proposals)

####***REMOVED***0.9.5 - 2015.04.30
* Added cap for `Function#@@hasInstance`
* Some fixes and optimizations

####***REMOVED***0.9.4 - 2015.04.27
* Fixed `RegExp` constructor

####***REMOVED***0.9.3 - 2015.04.26
* Some fixes and optimizations

####***REMOVED***0.9.2 - 2015.04.25
...
####***REMOVED***0.8.4 - 2015.04.18
* Uses `webpack` instead of `browserify` for browser builds - more compression-friendly result

####***REMOVED***0.8.3 - 2015.04.14
* Fixed `Array` statics with single entry points

####***REMOVED***0.8.2 - 2015.04.13
...
####***REMOVED***0.8.1 - 2015.04.03
* Fixed `Symbol.keyFor`

####***REMOVED***0.8.0 - 2015.04.02
...
####***REMOVED***0.5.4 - 2015.02.15
* Some fixes

####***REMOVED***0.5.3 - 2015.02.14
...
####***REMOVED***0.5.2 - 2015.02.10
* Some fixes

####***REMOVED***0.5.1 - 2015.02.09
* Some fixes

####***REMOVED***0.5.0 - 2015.02.08
...
####***REMOVED***0.4.5 - 2015.01.16
* Some fixes

####***REMOVED***0.4.4 - 2015.01.11
* Enabled CSP support

####***REMOVED***0.4.3 - 2015.01.10
* Added `Function` instances `name` property for IE9+

####***REMOVED***0.4.2 - 2015.01.10
* `Object` static methods accept primitives
* `RegExp` constructor can alter flags (IE9+)
* Added `Array.prototype[Symbol.unscopables]`

####***REMOVED***0.4.1 - 2015.01.05
* Some fixes

####***REMOVED***0.4.0 - 2015.01.03
...
####***REMOVED***0.1.2 - 2014.11.19
* `Map` & `Set` bug fix

####***REMOVED***0.1.1 - 2014.11.18
* Public release