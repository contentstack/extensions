...
###***REMOVED***As advertising: the author is looking for a good job :)
...
####***REMOVED***Caveats when using CommonJS API:
...
###***REMOVED***CommonJS and prototype methods without global namespace pollution
...
##***REMOVED***Custom build (from the command-line)
```
...
##***REMOVED***Custom build (from external scripts)
...
##***REMOVED***ECMAScript 6
[*CommonJS entry points:*](#commonjs)
```
core-js(/library)/es6
```
###***REMOVED***ECMAScript 6: Object
...
####***REMOVED***Unhandled rejection tracking
...
```
####***REMOVED***Caveats when using `Symbol` polyfill:
...
###***REMOVED***ECMAScript 6: Collections
...
```
####***REMOVED***Caveats when using collections polyfill:

* Weak-collections polyfill stores values as hidden properties of keys. It works correct and not leak in most cases. However, it is desirable to store a collection longer than its keys.

###***REMOVED***ECMAScript 6: Typed Arrays
...
```
####***REMOVED***Caveats when using typed arrays:
...
##***REMOVED***ECMAScript 7+ proposals
...
##***REMOVED***Web standards
[*CommonJS entry points:*](#commonjs)
```js
core-js(/library)/web
```
###***REMOVED***setTimeout / setInterval
...
```
###***REMOVED***Iterable DOM collections
