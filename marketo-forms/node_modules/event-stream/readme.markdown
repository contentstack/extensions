...
##***REMOVED***[simple example](https://github.com/dominictarr/event-stream/blob/master/examples/pretty.js):
...
#***REMOVED***merge (stream1,...,streamN) or merge (streamArray) 
> concat → merge
...
#***REMOVED***readable (asyncFunction) 
...
#***REMOVED***duplex (writeStream, readStream)
...
***REMOVED***Other Stream Modules

These modules are not included as a part of *EventStream* but may be
useful when working with streams.

#***REMOVED***[reduce (syncFunction, initial)](https://github.com/parshap/node-stream-reduce)
