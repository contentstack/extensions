***REMOVED***es6-iterator
#***REMOVED***ECMAScript 6 Iterator interface
...
###***REMOVED***Iterator(list) _(es6-iterator)_
...
###***REMOVED***ArrayIterator(arrayLike[, kind]) _(es6-iterator/array)_
...
###***REMOVED***StringIterator(str) _(es6-iterator/string)_
...
##***REMOVED***Function utilities

###***REMOVED***forOf(iterable, callback[, thisArg]) _(es6-iterator/for-of)_
...
###***REMOVED***get(obj) _(es6-iterator/get)_
...
###***REMOVED***isIterable(obj) _(es6-iterator/is-iterable)_
...
###***REMOVED***validIterable(obj) _(es6-iterator/valid-iterable)_

If _obj_ is an iterable it is returned. Otherwise _TypeError_ is thrown.

##***REMOVED***Method extensions

###***REMOVED***iterator.chain(iterator1[, …iteratorn]) _(es6-iterator/#/chain)_

Chain multiple iterators into one.

##***REMOVED***Tests [![Build Status](https://travis-ci.org/medikoo/es6-iterator.png)](https://travis-ci.org/medikoo/es6-iterator)
