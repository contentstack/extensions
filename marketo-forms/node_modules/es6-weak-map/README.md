***REMOVED***es6-weak-map
#***REMOVED***WeakMap collection as specified in ECMAScript6
...
#***REMOVED***Tests [![Build Status](https://travis-ci.org/medikoo/es6-weak-map.svg)](https://travis-ci.org/medikoo/es6-weak-map)
