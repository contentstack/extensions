...
code += "//***REMOVED***sourceMappingURL=/other/file.js.map"
// !function(){...}();
// // License: MIT
// //***REMOVED***sourceMappingURL=/other/file.js.map
```
...
##***REMOVED***`sourceMappingURL.getFrom(code)` ###

Returns the url of the sourceMappingURL comment in `code`. Returns `null` if
there is no such comment.

##***REMOVED***`sourceMappingURL.existsIn(code)` ###
...
##***REMOVED***`sourceMappingURL.insertBefore(code, string)` ###
...
##***REMOVED***`sourceMappingURL.regex` ###
