...
var comments = {
  ...
  universal: [
    "/****REMOVED***sourceMappingURL=foo.js.map */"
  ],
...
describe("sourceMappingURL", function() {
  ...
  describe(".getFrom", function() {
    ...
    it("can return an empty string as url", function() {
      expect(sourceMappingURL.getFrom("/****REMOVED***sourceMappingURL= */"))
        .to.equal("")
    })
    ...
    it("is detachable", function() {
      ...
      expect(get("/****REMOVED***sourceMappingURL=foo */"))
        .to.equal("foo")
    })
  ...
  describe(".existsIn", function() {
    ...
    it("is detachable", function() {
      ...
      expect(has("/****REMOVED***sourceMappingURL=foo */"))
        .to.equal(true)
    })
  ...
  describe(".removeFrom", function() {
    ...
    it("is detachable", function() {
      ...
      expect(remove("/****REMOVED***sourceMappingURL=foo */"))
        .to.equal("")
    })
  ...
  describe(".insertBefore", function() {
    ...
    it("inserts a string before a leading comment", function() {
      expect(sourceMappingURL.insertBefore("//***REMOVED***sourceMappingURL=foo.js.map\n" +
        "(function(){})", "code\n"))
        .to.equal("code\n//***REMOVED***sourceMappingURL=foo.js.map\n" +
          "(function(){})")
    })
    ...
    it("is detachable", function() {
      ...
      expect(insertBefore("/****REMOVED***sourceMappingURL=foo */", "bar"))
        .to.equal("bar/****REMOVED***sourceMappingURL=foo */")
    })
  ...
  describe("._innerRegex", function() {
    ...
    it("matches the contents of sourceMappingURL comments", function() {
      expect("***REMOVED***sourceMappingURL=http://www.example.com/foo/bar.js.map")
        .to.match(sourceMappingURL._innerRegex)
    })


    it("captures the url in the first capture group", function() {
      expect(sourceMappingURL._innerRegex.exec("***REMOVED***sourceMappingURL=foo")[1])
        .to.equal("foo")
    })
