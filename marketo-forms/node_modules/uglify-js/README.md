...
#***REMOVED***CLI source map options
...
- `--source-map "url='<URL>'"` to specify the URL where the source map can be found.
  ...
  `//***REMOVED***sourceMappingURL=` directive.
...
##***REMOVED***CLI mangling property names (`--mangle-props`)
...
```bash
$ rm -f /tmp/cache.json  ***REMOVED***start fresh
...
##***REMOVED***Mangling unquoted names (`--mangle-props keep_quoted`)
...
##***REMOVED***Debugging property name mangling
...
#***REMOVED***Minify options structure
...
`//***REMOVED***sourceMappingURL=out.js.map` in `result.code`. The value of
`filename` is only used to set `file` attribute (see [the spec][sm-spec])
in source map file.
...
##***REMOVED***Mangle properties options
...
##***REMOVED***Keeping copyright notices or other comments
...
##***REMOVED***The `unsafe` `compress` option
...
##***REMOVED***Conditional compilation API
...
##***REMOVED***Using native Uglify AST with `minify()`
```javascript
...
##***REMOVED***Working with Uglify AST
...
##***REMOVED***ESTree / SpiderMonkey AST
...
##***REMOVED***Uglify Fast Minify Mode
...
###***REMOVED***Source maps and debugging
