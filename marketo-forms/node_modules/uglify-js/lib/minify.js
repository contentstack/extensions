...
function read_source_map(name, code) {
    var match = /\n\/\/***REMOVED***sourceMappingURL=data:application\/json(;.*?)?;base64,(.*)/.exec(code);
    if (!match) {
        ...
        if (!HOP(options.output, "code") || options.output.code) {
            ...
            if (options.sourceMap) {
                ...
                if (options.sourceMap.url == "inline") {
                    result.code += "\n//***REMOVED***sourceMappingURL=data:application/json;charset=utf-8;base64," + to_base64(result.map);
                } else if (options.sourceMap.url) {
                    result.code += "\n//***REMOVED***sourceMappingURL=" + options.sourceMap.url;
                }
            }
        }
