...
#***REMOVED***6.16.0 (2017-02-23)

##***REMOVED***:rocket: New Feature
...
##***REMOVED***:eyeglasses: Spec Compliancy
...
#***REMOVED***v6.11.6 (2016-10-12)

##***REMOVED***:bug: Bug Fix/Regression
...
```bash
***REMOVED***So in the case of a missing ending curly (`}`)
...
#***REMOVED***v6.11.4 (2016-10-03)

Temporary rollback for erroring on trailing comma with spread (#154) (Henry Zhu)

#***REMOVED***v6.11.3 (2016-10-01)
...
#***REMOVED***6.11.0 (2016-09-22)

##***REMOVED***Spec Compliancy (will break CI)
...
#***REMOVED***6.9.2 (2016-09-09)

The only change is to remove the `babel-runtime` dependency by compiling with Babel's ES2015 loose mode. So using babylon standalone should be smaller.

#***REMOVED***6.9.1 (2016-08-23)
...
#***REMOVED***6.9.0 (2016-08-16)

##***REMOVED***New syntax support
...
#***REMOVED***6.8.4 (2016-07-06)

##***REMOVED***Bug Fixes

- Fix the location of params, when flow and default value used ([#68](https://github.com/babel/babylon/pull/68)) @danez

#***REMOVED***6.8.3 (2016-07-02)

##***REMOVED***Bug Fixes

- Fix performance regression introduced in 6.8.2 with conditionals ([#63](https://github.com/babel/babylon/pull/63)) @danez

#***REMOVED***6.8.2 (2016-06-24)
...
#***REMOVED***6.8.0 (2016-05-02)

###***REMOVED***New Feature

####***REMOVED***Parse Method Parameter Decorators ([#12](https://github.com/babel/babylon/pull/12))
...
####***REMOVED***Parse for-await statements (w/ `asyncGenerators` plugin) ([#17](https://github.com/babel/babylon/pull/17))
