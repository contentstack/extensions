...
test('\nintegrated', function (t) {
  t.test('\n***REMOVED***reading root without filter', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***normal: ["*.ext1", "*.ext3"]', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***directories only', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***both directories + files', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***directory filter with directories only', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***directory and file filters with both entries', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***negated: ["!*.ext1", "!*.ext3"]', function (t) {
    t.plan(2);
  ...
  t.test('\n***REMOVED***no options given', function (t) {
    t.plan(1);
    readdirp()
      .on('error', function (err) {
  ...
  t.test('\n***REMOVED***mixed: ["*.ext1", "!*.ext3"]', function (t) {
    t.plan(1);
...
test('\napi separately', function (t) {
  ...
  t.test('\n***REMOVED***handleError', function (t) {
    t.plan(1);
  ...
  t.test('\n***REMOVED***when stream is paused and then resumed', function (t) {
    t.plan(6);
    var api = streamapi()
      , resumed = false
  ...
  t.test('\n***REMOVED***when a stream is paused it stops walking the fs', function (t) {
    var resumed = false,
      mockedAPI = streamapi();
  ...
  t.test('\n***REMOVED***when a stream is destroyed, it emits "closed", but no longer emits "data", "warn" and "error"', function (t) {
    var api = streamapi()
      , fatalError = new Error('fatal!')
      , nonfatalError = new Error('nonfatal!')
      , processedData = 'some data'
