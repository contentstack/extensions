...
test('\nreading root using glob filter', function (t) {
  ...
  t.test('\n***REMOVED***["root_dir1", "*dir1_subdir1"]', function (t) {
    t.plan(1);
  ...
  t.test('\n***REMOVED***negated: "!*.ext1"', function (t) {
    t.plan(1);
    readdirp(opts( { fileFilter: '!*.ext1' } ), function (err, res) {
  ...
  t.test('\n***REMOVED***leading and trailing spaces: [" *.ext1", "*.ext3 "]', function (t) {
    t.plan(1);
    readdirp(opts( { fileFilter: [ ' *.ext1', '*.ext3 ' ] } ), function (err, res) {
      t.equals(res.files.length, ext1Files + ext3Files, 'all ext1 and ext3 files');
      t.end();
  ...
  t.test('\n***REMOVED***** glob pattern', function (t) {
    t.plan(1);
    readdirp(opts( { fileFilter: '**/*.ext1' } ), function (err, res) {
...
test('\n\nreading root using function filter', function (t) {
  t.test('\n***REMOVED***file filter -> "contains root_dir2"', function (t) {
    t.plan(1);
    readdirp(
  ...
  t.test('\n***REMOVED***directory filter -> "name has length 9"', function (t) {
    t.plan(1);
    readdirp(
