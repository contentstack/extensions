...
function renderToShowExperimentDetails(response) {
  ...
  $('.experiment-key').append("<div class=\"btn-container\"><button class=\"btn goBack\" data-toggle=\"tooltip\" title=\"Go Back\" type=\"button\"><i class=\"back fa fa-angle-left\"></i></button> <div class=\"keyLabel\">".concat(response.key, "</div> </div>"));
  response.variations.forEach(function (data) {
    if (data.description === undefined) {
      $('.experiment-data').append("<tr><td id=\"".concat(data.key, "\" class=\"key\">").concat(data.key, "</td><td data-toggle=\"tooltip\" title=\"Copy Variation Key\"><button class=\"cpbtn\" data-clipboard-target=\"#").concat(data.key, "\"><i class=\"fa fa-copy\"></i></button></td><td class=\"weight\"> ").concat(data.weight / 100, "%</td>"));
    } else {
      $('.experiment-data').append("<tr><td data-toggle=\"tooltip\" title=\"Description :  ".concat(data.description, "\"  id=\"").concat(data.key, "\" class=\"key\">").concat(data.key, "</td><td data-toggle=\"tooltip\" title=\"Copy Variation Key\"><button class=\"cpbtn\" data-clipboard-target=\"#").concat(data.key, "\"><i class=\"fa fa-copy\"></i></button></td><td class=\"weight\"> ").concat(data.weight / 100, "%</td>"));
    }
  });
