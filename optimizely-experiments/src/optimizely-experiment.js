...
function renderToShowExperimentDetails(response) {
  ...
  $('.audiences').append(
    '<div data-toggle="tooltip" title="Audiences" class="audienceLabel"><a class="audienceLink" href="" target="_blank"> <div class="audience-btn"></div>Audiences<i class="link fa fa-external-link"></i></a></div>'
  );
        ...
        if (typeof key !== 'string') {
          audiences.forEach((audience) => {
            if (audience.id === key.audience_id) {
              $('.audiences').append(
                `<div class="keyName" id="${audience.id}">${audience.name}</div>`
              );
            }
          });
        }
...
function domChangeListnerOfExperimentsListPage() {
  $('.details').click((e) => {
    ...
    $(
      '.delete-container, .list, .edit-container, .new-experiment-container, .refresh-btn'
    ).hide();
  ...
  $('.result-icon').click((e) => {
    ...
    var ExperimentId = $(e.currentTarget)
      .parent()
      .parent()
      .parent()
      .siblings('.details')
  ...
  $('.action').click((e) => {
    ...
    let ExperimentId = $(e.currentTarget)
      .parent()
      .parent()
      .siblings('.details')
      .attr('id');
